# Privacy Policy — JWT Companion

**Effective date:** 2026-08-04

JWT Companion is a Gap Hunter Labs plugin for IntelliJ Platform IDEs.
...
**Nothing.** JWT Companion does not collect, store, transmit, or sell
...
**None.** JWT Companion makes zero network calls during normal
...
None. JWT Companion has no third-party SDKs, no analytics libraries,
